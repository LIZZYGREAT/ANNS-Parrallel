...
void run_mpi_evaluation(int thread_count, int nprobe, SearcherType* searcher,
    ...
    if (rank == 0) {
        ...
        float imbalance_ratio = (avg_local_time_us > 0) ? (max_local_time_us / avg_local_time_us) : 1.0f; // 计算倾斜率
